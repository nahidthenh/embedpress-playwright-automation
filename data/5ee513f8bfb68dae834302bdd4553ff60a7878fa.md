...
Call log:
  ...
  - waiting for locator('iframe[title="Aircraft mechanic probing an opened jet engine of an airplane with a portable camera and looking at the monitor in the maintenance hangar"]').contentFrame().getByRole('complementary')
    ...
    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/elementor/gettyimages.spec.js:5:231
```
...
- banner:
  ...
  - button "Search magnifier":
    - img
  - paragraph
- text: https://www.gettyimages.com/detail/photo/aircraft-mechanic-probing-an-opened-jet-engine-of-royalty-free-image/1097276708
- contentinfo:
