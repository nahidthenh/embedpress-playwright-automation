...
- Name: Embed Classic Tumblr source
- Location: /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/classic/tumblr.spec.js:3:1
...
Call log:
  ...
  - waiting for locator('iframe[title="Tumblr post"]').contentFrame().getByRole('link', { name: 'nahidwpd', exact: true })
    ...
    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/classic/tumblr.spec.js:5:131
```
...
- banner:
  ...
  - button "Search magnifier":
    - img
  - paragraph
- heading "Tumblr Classic" [level=1]
- main:
  - article:
    - paragraph
    - iframe
...
```ts
  ...
  2 |
  3 | test('Embed Classic Tumblr source', async ({ page }) => {
  4 |     await page.goto('https://embedpress.wpqa.site/playwright-classic-editor/tumblr-classic/');
