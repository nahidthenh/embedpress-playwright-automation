...
Locator: locator('#ep-elementor-content-60c5872 iframe[title="sample_pdf"]').contentFrame().getByRole('button', { name: 'Zoom In' })
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('#ep-elementor-content-60c5872 iframe[title="sample_pdf"]').contentFrame().getByRole('button', { name: 'Zoom In' })

    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/elementor/pdf/modern_pdf.spec.js:31:85
```
