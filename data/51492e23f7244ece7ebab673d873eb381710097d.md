...
Call log:
  ...
  - waiting for locator('iframe[title="DAS UNBEGREIFLICHE SCHWEIGEN DER WELT"]').contentFrame().getByRole('link', { name: 'Bild: DAS UNBEGREIFLICHE' })
    ...
    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/elementor/medienarchiv.spec.js:5:160
```
...
- banner:
  ...
  - button "Search magnifier":
    - img
  - paragraph
- text: https://medienarchiv.zhdk.ch/entries/8c59a56e-4f97-43b1-967b-e07591bc1975 https://medienarchiv.zhdk.ch/entries/8c59a56e-4f97-43b1-967b-e07591bc1975
- contentinfo:
