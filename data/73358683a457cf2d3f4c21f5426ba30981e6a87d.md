...
- Name: Embed Gutenberg Ludus source
- Location: /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/ludus.spec.js:3:1
...
Call log:
  ...
  - waiting for locator('iframe[title="User guide"]').contentFrame().getByText('User guide01/39CloneDownload')
    ...
    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/ludus.spec.js:6:119
```
...
- banner:
  ...
  - button "Search magnifier":
    - img
  - paragraph
- heading "Gutenberg Ludus" [level=1]
- main:
  - article
- contentinfo:
...
```ts
  ...
  2 |
  3 | test('Embed Gutenberg Ludus source', async ({ page }) => {
  4 |     await page.goto('gutenberg-ludus/');
