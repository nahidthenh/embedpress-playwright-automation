...
```
Error: page.goto: net::ERR_TIMED_OUT at https://embedpress.wpqa.site/cl-datawrapper/
Call log:
  - navigating to "https://embedpress.wpqa.site/cl-datawrapper/", waiting until "load"

    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/classic/datawrapper.spec.js:4:16
```
