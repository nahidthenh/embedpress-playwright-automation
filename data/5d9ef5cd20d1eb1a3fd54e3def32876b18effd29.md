...
- Location: /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/elementor/google/google-slides.spec.js:11:5
...
Call log:
  ...
  - waiting for locator('iframe').contentFrame().locator('.sketchyViewerContainer')
    ...
    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/elementor/google/google-slides.spec.js:17:30
```
...
- banner:
  ...
  - button "Search magnifier":
    - img
  - paragraph
- heading "Default Google Slides 1140x800" [level=2]
```
