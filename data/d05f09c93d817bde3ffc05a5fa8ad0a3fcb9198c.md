...
- Name: Embed Gutenberg Instagram Reels Support
- Location: /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/instagram-reel.spec.js:3:1
...
Call log:
  ...
  - waiting for getByText('Fetching content').contentFrame().getByText('me_tester23Original audioView')
    ...
    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/instagram-reel.spec.js:5:112
```
...
- banner:
  ...
  - button "Search magnifier":
    - img
  - paragraph
- heading "Gutenberg Instagram reels support" [level=1]
- main:
  - article:
    - blockquote: Instagram will load in the frontend.
    - text: ==
...
```ts
  ...
  2 |
  3 | test('Embed Gutenberg Instagram Reels Support', async ({ page }) => {
  4 |     await page.goto('gutenberg-instagram-reels-support/');
