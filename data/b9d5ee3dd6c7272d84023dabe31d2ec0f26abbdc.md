...
- Name: Gutenberg Google Sheets >> Gutenberg Google Sheets
- Location: /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/google/google-sheets.spec.js:11:5
...
Call log:
  ...
  - waiting for locator('iframe')
    ...
    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/google/google-sheets.spec.js:17:30
```
...
- banner:
  ...
  - button "Search magnifier":
    - img
  - paragraph
- heading "Gutenebrg Google Sheets" [level=1]
- main:
  - article:
    - heading "Google Sheets 1140×800" [level=2]
- contentinfo:
...
```ts
   ...
   2 |
   3 | const slug = 'playwright-gutenberg/gutenebrg-google-sheets';
   4 |
   5 | test.describe("Gutenberg Google Sheets", () => {
   6 |     test.beforeEach(async ({ page }) => {
   7 |         await page.goto(slug);
   8 |         // await page.waitForLoadState('networkidle');
   9 |     });
  10 |
  11 |     test('Gutenberg Google Sheets', async ({ page }) => {
  12 |         // Check iframe visibility        
  13 |         await expect(page.getByRole('heading', { name: 'Google Sheets 1140×' })).toBeVisible();
  14 |
