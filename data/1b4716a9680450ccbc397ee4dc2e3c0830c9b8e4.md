...
- Name: Embed Gutenberg smugmug source
- Location: /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/smugmug.spec.js:3:1
...
Call log:
  ...
  - waiting for getByRole('link').filter({ hasText: /^$/ })
    ...
    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/smugmug.spec.js:5:68
```
...
- banner:
  ...
  - button "Search magnifier":
    - img
  - paragraph
- heading "Smugmug Gutenberg" [level=1]
- main:
  - article:
    - heading "Hello World ! ff" [level=2]
- contentinfo:
...
```ts
  ...
  2 |
  3 | test('Embed Gutenberg smugmug source', async ({ page }) => {
  4 |     await page.goto('https://embedpress.wpqa.site/smugmug-gutenberg/');
