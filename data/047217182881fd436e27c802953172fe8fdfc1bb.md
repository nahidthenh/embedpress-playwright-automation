...
Call log:
  ...
  - waiting for locator('iframe').contentFrame().locator('footer > div > div > div')
    ...
    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/classic/fader.spec.js:5:93
```
...
- banner:
  ...
  - button "Search magnifier":
    - img
  - paragraph
- heading "Classic Fader" [level=1]
- main:
  - article: https://app.getfader.com/projects/1ca5807e-13d9-4b09-9ea2-db187eaeac12/publish
- contentinfo:
