...
- Name: Embed Gutenberg NRK Radio source
- Location: /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/nrk-radio.spec.js:3:1
...
Call log:
  ...
  - waiting for locator('iframe')
    ...
    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/nrk-radio.spec.js:5:42
```
...
- banner:
  ...
  - button "Search magnifier":
    - img
  - paragraph
- heading "NRK Radio – Gutenberg" [level=1]
- main:
  - article:
    - paragraph
- contentinfo:
...
```ts
   ...
   2 |
   3 | test('Embed Gutenberg NRK Radio source', async ({ page }) => {
   4 |     await page.goto('https://embedpress.wpqa.site/nrk-radio/');
