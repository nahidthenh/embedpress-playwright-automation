...
- Name: Embed Classic Geographic UK source
- Location: /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/classic/geographic_uk.spec.js:3:1
...
Call log:
  ...
  - waiting for getByRole('link', { name: 'The Ferry to Shepperton' })
    ...
    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/classic/geographic_uk.spec.js:5:79
```
...
- banner:
  ...
  - button "Search magnifier":
    - img
  - paragraph
- heading "Gu – Geographic UK" [level=1]
- main:
  - article
- contentinfo:
...
```ts
  ...
  2 |
  3 | test('Embed Classic Geographic UK source', async ({ page }) => {
  4 |     await page.goto('playwright-gutenberg/gu-geographic-uk/');
