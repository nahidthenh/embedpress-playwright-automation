...
- Name: Embed Gutenberg Canva source
- Location: /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/canva.spec.js:3:1
...
Call log:
  ...
  - waiting for locator('iframe[title="Accounting Service Website in Black and White Photographic Style"]').contentFrame().locator('div:nth-child(2) > .uk_25A > .Izwocg')
    ...
    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/canva.spec.js:5:179
```
...
```ts
  ...
  2 |
  3 | test('Embed Gutenberg Canva source', async ({ page }) => {
  4 |     await page.goto('https://embedpress.wpqa.site/gu-canva/');
