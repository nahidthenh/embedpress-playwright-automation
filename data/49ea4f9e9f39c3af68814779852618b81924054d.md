...
- Location: /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/wordwall.spec.js:3:1
...
Call log:
  ...
  - waiting for locator('iframe[title="K3 match the words wk36"]').contentFrame().locator('canvas')
    ...
    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/wordwall.spec.js:5:108
```
...
- banner:
  ...
  - button "Search magnifier":
    - img
  - paragraph
- heading "Gutenberg WordWall" [level=1]
- main:
  - article
- contentinfo:
...
```ts
   ...
   4 |     await page.goto('https://embedpress.wpqa.site/playwright-gutenberg/gutenberg-wordwall/');
