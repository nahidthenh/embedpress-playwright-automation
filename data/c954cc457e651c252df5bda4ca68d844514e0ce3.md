...
- Name: Embed Classic NRK Radio source
- Location: /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/classic/nrk-radio.spec.js:3:1
...
Call log:
  ...
  - waiting for locator('iframe')
    ...
    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/classic/nrk-radio.spec.js:5:42
```
...
- banner:
  ...
  - button "Search magnifier":
    - img
  - paragraph
- heading "Classic NRK Radio" [level=1]
- main:
  - article
```
...
```ts
   ...
   2 |
   3 | test('Embed Classic NRK Radio source', async ({ page }) => {
   4 |     await page.goto('https://embedpress.wpqa.site/playwright-classic-editor/classic-nrk-radio/');
