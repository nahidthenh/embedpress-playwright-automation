...
- Location: /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/animoto.spec.js:3:1
...
Call log:
  ...
  - waiting for locator('iframe').contentFrame().locator('.vjs-poster')
    ...
    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/animoto.spec.js:5:80
```
...
- banner:
  ...
  - button "Search magnifier":
    - img
  - paragraph
- heading "Gutenberg Animoto" [level=1]
- main:
  - article
- contentinfo:
...
```ts
  ...
  4 |     await page.goto('gutenberg-animoto/');
