...
- Name: Embed Gutenberg vidyard source
- Location: /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/vidyard.spec.js:3:1
...
Call log:
  ...
  - waiting for locator('iframe[title="Vidyard Recording"]').contentFrame().getByTestId('splashScreen')
    ...
    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/vidyard.spec.js:5:112
```
...
```ts
   ...
   2 |
   3 | test('Embed Gutenberg vidyard source', async ({ page }) => {
   4 |     await page.goto('https://embedpress.wpqa.site/gu-vidyard/');
