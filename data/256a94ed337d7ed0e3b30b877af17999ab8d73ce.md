...
- Name: Embed Classic BoomPlay source
- Location: /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/classic/boomplay.spec.js:3:1
...
Call log:
  ...
  - waiting for locator('iframe').contentFrame().locator('.header_bg > div')
    ...
    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/classic/boomplay.spec.js:5:85
```
...
- banner:
  ...
  - button "Search magnifier":
    - img
  - paragraph
- heading "Classic boomplay" [level=1]
- main:
  - article
```
...
```ts
   ...
   2 |
   3 | test('Embed Classic BoomPlay source', async ({ page }) => {
   4 |     await page.goto('https://embedpress.wpqa.site/playwright-classic-editor/classic-boomplay/');
