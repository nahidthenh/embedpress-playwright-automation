...
Call log:
  ...
  - waiting for getByRole('link').filter({ hasText: /^$/ })
    ...
    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/elementor/smugmug.spec.js:5:68
```
...
- banner:
  ...
  - button "Search magnifier":
    - img
  - paragraph
- text: https://mdhasan.smugmug.com/Tinified/i-Lqv2Wbp/A
- heading "Height / Width Not working properly" [level=2]
- contentinfo:
