...
Locator: getByRole('heading', { name: 'Classic Content Protection' })
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByRole('heading', { name: 'Classic Content Protection' })

    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/classic/content-protection.spec.js:12:89
```
