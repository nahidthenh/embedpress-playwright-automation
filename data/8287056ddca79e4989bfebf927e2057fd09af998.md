...
Locator: locator('#ep-elements-id-27221be').getByText('PausePlay')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('#ep-elements-id-27221be').getByText('PausePlay')

    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/elementor/google/youtube-others.spec.js:57:86
```
