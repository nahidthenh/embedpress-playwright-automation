...
- Name: Embed Gutenberg Flickr source
- Location: /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/flickr.spec.js:3:1
...
Call log:
  ...
  - waiting for getByRole('link', { name: 'The Sledge' })
    ...
    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/flickr.spec.js:5:66
```
...
- banner:
  ...
  - button "Search magnifier":
    - img
  - paragraph
- heading "Gutenberg Flickr" [level=1]
- main:
  - article
- contentinfo:
...
```ts
  ...
  2 |
  3 | test('Embed Gutenberg Flickr source', async ({ page }) => {
  4 |     await page.goto('https://embedpress.wpqa.site/gutenberg-flickr/');
