...
Locator: locator('iframe').contentFrame().locator('#root div').filter({ hasText: 'Open Sandboxindex.html12345<!' }).nth(1)
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('iframe').contentFrame().locator('#root div').filter({ hasText: 'Open Sandboxindex.html12345<!' }).nth(1)

    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/classic/codesandbox.spec.js:5:138
```
...
- banner:
  - banner:
    - heading "Classic – CodeSandBox" [level=1]
- main:
  - article: https://codesandbox.io/embed/ygz3rr?view=preview&module=%2Findex.html&hidenavigation=1&expanddevtools=1
- contentinfo:
