...
- Name: Embed Gutenberg Learning Apps source
- Location: /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/learning-apps.spec.js:3:1
...
Call log:
  ...
  - waiting for locator('iframe[title="Periodic classification"]').contentFrame().locator('#frame').contentFrame().getByRole('link', { name: 'Show app in fullscreen' })
    ...
    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/learning-apps.spec.js:5:177
```
...
- banner:
  ...
  - button "Search magnifier":
    - img
  - paragraph
- heading "Gu – learning-Apps" [level=1]
- main:
  - article
- contentinfo:
...
```ts
   ...
   2 |
   3 | test('Embed Gutenberg Learning Apps source', async ({ page }) => {
   4 |     await page.goto('playwright-gutenberg/gu-learning-apps/');
