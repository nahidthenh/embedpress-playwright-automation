...
Locator: locator('#embedpress-pdf-1722764697745 iframe[title="sample_pdf"]').contentFrame().locator('iframe[title="View"]').contentFrame().getByRole('link', { name: 'Next page' }).first()
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('#embedpress-pdf-1722764697745 iframe[title="sample_pdf"]').contentFrame().locator('iframe[title="View"]').contentFrame().getByRole('link', { name: 'Next page' }).first()
