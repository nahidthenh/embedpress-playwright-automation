...
- Location: /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/codesandbox.spec.js:3:1
...
Call log:
  ...
  - waiting for locator('iframe')
    ...
    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/codesandbox.spec.js:5:42
```
...
- banner:
  ...
  - button "Search magnifier":
    - img
  - paragraph
- heading "Gu – CodeSandBox" [level=1]
- main:
  - article:
    - paragraph
- contentinfo:
...
```ts
  ...
  4 |     await page.goto('https://embedpress.wpqa.site/gu-codesandbox/');
