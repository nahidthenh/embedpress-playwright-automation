...
Error: expect.toBeVisible: Error: strict mode violation: locator('#ep-elements-id-d506231').getByRole('img') resolved to 2 elements:
    1) <img width="true" height="true" loading="lazy" decoding="async" src="https://docs.google.com/drawings/d/e/2PACX-1vSlcFvwMSTMup-Zep26SNugijQiv59ELFpg9eBWTRfJkDntgFL6c0zS1m6GYawLb5HH2TtT2E5zGFQL/pub?w=960&h=720"/> aka getByRole('img').nth(1)
