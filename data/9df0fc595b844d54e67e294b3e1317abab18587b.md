...
- Name: Embed Classic Ludus source
- Location: /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/classic/ludus.spec.js:3:1
...
Call log:
  ...
  - waiting for locator('iframe[title="User guide"]').contentFrame().getByText('User guide01/39CloneDownload')
    ...
    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/classic/ludus.spec.js:6:119
```
...
```ts
  ...
  2 |
  3 | test('Embed Classic Ludus source', async ({ page }) => {
  4 |     await page.goto('classic-ludus/');
