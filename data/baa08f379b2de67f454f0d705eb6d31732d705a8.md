...
- Name: Embed Gutenberg Airtable source
- Location: /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/airtable.spec.js:3:1
...
Call log:
  ...
  - waiting for locator('iframe').contentFrame().locator('.dataRightPane')
    ...
    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/airtable.spec.js:5:83
```
...
- banner:
  ...
  - button "Search magnifier":
    - img
  - paragraph
- heading "Gutenberg Airtable" [level=1]
- main:
  - article
- contentinfo:
...
```ts
  ...
  2 |
  3 | test('Embed Gutenberg Airtable source', async ({ page }) => {
  4 |     await page.goto('https://embedpress.wpqa.site/playwright-elementor/gutenberg-airtable/');
