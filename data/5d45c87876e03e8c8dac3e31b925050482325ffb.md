...
- Name: Spreaker Gutenberg >> Dark Theme & Red Color
- Location: /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/spreaker.spec.js:147:5
...
Locator: locator('iframe[title="This is title"]').nth(3).contentFrame().locator('.widget.theme_dark.theme_with_playlist')
Expected pattern: /widget theme_dark theme_with_playlist/
Received: <element(s) not found>
Call log:
  - expect.toHaveClass with timeout 5000ms
  - waiting for locator('iframe[title="This is title"]').nth(3).contentFrame().locator('.widget.theme_dark.theme_with_playlist')

    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/spreaker.spec.js:180:34
```
