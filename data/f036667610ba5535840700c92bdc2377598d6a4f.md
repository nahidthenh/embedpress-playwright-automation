...
- Name: Embed Classic Animoto source
- Location: /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/classic/animoto.spec.js:3:1
...
Call log:
  ...
  - waiting for locator('iframe').contentFrame().locator('.vjs-poster')
    ...
    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/classic/animoto.spec.js:5:80
```
...
- banner:
  ...
  - button "Search magnifier":
    - img
  - paragraph
- heading "Classic Animoto" [level=1]
- main:
  - article
```
...
```ts
  ...
  2 |
  3 | test('Embed Classic Animoto source', async ({ page }) => {
  4 |     await page.goto('classic-animoto/');
