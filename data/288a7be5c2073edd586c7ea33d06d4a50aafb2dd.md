...
Call log:
  ...
  - waiting for locator('iframe[title="The Invisible Side of Design"]').contentFrame().getByRole('button', { name: 'Next slide' })
    ...
    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/elementor/speaker-deck.spec.js:5:139
```
...
- banner:
  ...
  - button "Search magnifier":
    - img
  - paragraph
- text: https://speakerdeck.com/smashingmag/the-invisible-side-of-design
- contentinfo:
