...
- Name: Embed Gutenberg Tumblr source
- Location: /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/tumblr.spec.js:3:1
...
Call log:
  ...
  - waiting for locator('iframe[title="Tumblr post"]').contentFrame().getByRole('link', { name: 'nahidwpd', exact: true })
    ...
    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/tumblr.spec.js:5:131
```
...
- banner:
  ...
  - button "Search magnifier":
    - img
  - paragraph
- heading "Tumblr Guteberg" [level=1]
- main:
  - article
- contentinfo:
...
```ts
  ...
  2 |
  3 | test('Embed Gutenberg Tumblr source', async ({ page }) => {
  4 |     await page.goto('https://embedpress.wpqa.site/tumblr-guteberg/');
