...
Call log:
  ...
  - waiting for locator('iframe').first()
    ...
    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/classic/google/google-photos.spec.js:17:30
```
...
- banner:
  ...
  - button "Search magnifier":
    - img
  - paragraph
- heading "Classic Google Photos" [level=1]
- main:
  - article
```
