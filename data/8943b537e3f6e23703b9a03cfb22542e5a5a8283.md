...
- Location: /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/elementor/google/docs.spec.js:12:5
...
Call log:
  ...
  - waiting for locator('iframe').contentFrame().locator('body')
    ...
    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/elementor/google/docs.spec.js:13:67
```
...
- banner:
  ...
  - button "Search magnifier":
    - img
  - paragraph
- heading "Google Docs Elementor" [level=2]
```
