...
Call log:
  ...
  - waiting for locator('iframe').first()
    ...
    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/elementor/linkedin.spec.js:18:45
```
...
- banner:
  ...
  - button "Search magnifier":
    - img
  - paragraph
- heading "Default linkedIn Embed Test" [level=2]
```
