...
- Name: Embed Gutenberg BoomPlay source
- Location: /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/boomplay.spec.js:3:1
...
Call log:
  ...
  - waiting for locator('iframe').contentFrame().locator('.header_bg > div')
    ...
    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/boomplay.spec.js:5:85
```
...
```ts
   ...
   2 |
   3 | test('Embed Gutenberg BoomPlay source', async ({ page }) => {
   4 |     await page.goto('https://embedpress.wpqa.site/gu-boomplay/');
