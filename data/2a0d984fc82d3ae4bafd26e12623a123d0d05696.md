...
- Location: /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/gyazo.spec.js:3:1
...
Locator: locator('#post-10603 img')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('#post-10603 img')

    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/gyazo.spec.js:5:51
```
...
```ts
  ...
  4 |     await page.goto('https://embedpress.wpqa.site/gu-gyazo/');
> 5 |     await expect(page.locator('#post-10603 img')).toBeVisible();
    |                                                   ^ Error: Timed out 5000ms waiting for expect(locator).toBeVisible()
  6 | });
  7 |
