...
- Name: Embed Gutenberg Padlet source
- Location: /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/padlet.spec.js:3:1
...
Call log:
  ...
  - waiting for locator('iframe').contentFrame().getByRole('heading', { name: 'Canvas' })
    ...
    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/padlet.spec.js:5:98
```
...
- banner:
  ...
  - button "Search magnifier":
    - img
  - paragraph
- heading "Gutenberg padlet" [level=1]
- main:
  - article
- contentinfo:
...
```ts
   ...
   2 |
   3 | test('Embed Gutenberg Padlet source', async ({ page }) => {
   4 |     await page.goto('playwright-gutenberg/gutenberg-padlet/');
