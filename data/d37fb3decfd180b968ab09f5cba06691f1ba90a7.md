...
- Location: /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/gumroad.spec.js:3:1
...
Call log:
  ...
  - waiting for locator('iframe').contentFrame().locator('.preview').first()
    ...
    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/gumroad.spec.js:5:85
```
...
- banner:
  ...
  - button "Search magnifier":
    - img
  - paragraph
- heading "Gutenberg Gumroad" [level=1]
- main:
  - article
- contentinfo:
...
```ts
   ...
   4 |     await page.goto('https://embedpress.wpqa.site/gutenberg-gumroad/');
