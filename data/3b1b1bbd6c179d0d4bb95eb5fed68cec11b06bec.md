...
Call log:
  ...
  - waiting for locator('iframe').contentFrame().getByText('iPad Pro 10.5" Screen Replacement Author: Dominik Schnabelrauch')
    ...
    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/classic/ifixit.spec.js:5:134
```
...
- banner:
  ...
  - button "Search magnifier":
    - img
  - paragraph
- heading "Classic iFixit" [level=1]
- main:
  - article
```
