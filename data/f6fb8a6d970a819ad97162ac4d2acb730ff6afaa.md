...
Call log:
  ...
  - retrying click action
    ...
    - scrolling into view if needed
    - done scrolling
    - <span data-l10n-id="pdfjs-spread-odd-button-label">Odd Spreads</span> from <div role="radiogroup" id="spreadModeButtons">…</div> subtree intercepts pointer events
  ...
  - retrying click action
    ...
    - scrolling into view if needed
    - done scrolling
    - <button role="radio" tabindex="68" id="spreadEven" aria-checked="false" class="secondaryToolbarButton" data-l10n-id="pdfjs-spread-even-button" title="Join page spreads starting with even-numbered pages">…</button> from <div role="radiogroup" id="spreadModeButtons">…</div> subtree intercepts pointer events
  - retrying click action
    - waiting 500ms
    - waiting for element to be visible, enabled and stable
    - element is visible, enabled and stable
    - scrolling into view if needed
    - done scrolling
    - <div class="e-con-inner">…</div> from <div data-id="0c205e2" data-element_type="container" class="elementor-element elementor-element-0c205e2 e-flex e-con-boxed e-con e-parent e-lazyloaded">…</div> subtree intercepts pointer events
