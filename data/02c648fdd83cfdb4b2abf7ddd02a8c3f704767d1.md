...
- Location: /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/toornament.spec.js:3:1
...
Call log:
  ...
  - waiting for locator('iframe')
    ...
    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/toornament.spec.js:5:42
```
...
- banner:
  ...
  - button "Search magnifier":
    - img
  - paragraph
- heading "Gutenberg Toornament" [level=1]
- main:
  - article
- contentinfo:
...
```ts
  ...
  4 |     await page.goto('https://embedpress.wpqa.site/gutenberg-toornament/');
