...
- Name: Embed Gutenberg Sketchfab source
- Location: /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/sketchfab.spec.js:3:1
...
Call log:
  ...
  - waiting for locator('iframe[title="Short-beaked Common Dolphin"]').contentFrame().locator('img').nth(1)
    ...
    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/sketchfab.spec.js:5:114
```
...
```ts
   ...
   2 |
   3 | test('Embed Gutenberg Sketchfab source', async ({ page }) => {
   4 |     await page.goto('https://embedpress.wpqa.site/playwright-gutenberg/gu-sketchfab/');
