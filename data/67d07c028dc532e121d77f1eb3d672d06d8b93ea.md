...
- Name: Embed Gutenberg Rumble source
- Location: /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/rumble.spec.js:3:1
...
Call log:
  ...
  - waiting for locator('iframe[title="Private Tour of the World\\&apos\\;s Largest Pond Facility"]').contentFrame().getByRole('link', { name: 'Private Tour of the World\'s' })
    ...
    at /home/runner/work/embedpress-playwright-automation/embedpress-playwright-automation/tests/gutenberg/rumble.spec.js:5:185
```
...
- banner:
  ...
  - button "Search magnifier":
    - img
  - paragraph
- heading "Rumble Gutenberg" [level=1]
- main:
  - article
- contentinfo:
...
```ts
  ...
  2 |
  3 | test('Embed Gutenberg Rumble source', async ({ page }) => {
  4 |     await page.goto('https://embedpress.wpqa.site/rumble-gutenberg/');
