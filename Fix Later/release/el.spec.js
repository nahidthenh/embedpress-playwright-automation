...
test.describe('Elementor source embed TestCases', () => {
    test.beforeEach(async ({ page }) => {
        await page.goto('https://ep-automation.mdnahidhasan.com/wp-admin/post.php?post=9540&action=elementor');
    });
    ...
    test('Elementor source embed', async ({ page }) => {
        ...
        await page.waitForTimeout(3000);
        await page.goto('https://ep-automation.mdnahidhasan.com/playwright-elementor/elementor-source-embed-test-cases/');
